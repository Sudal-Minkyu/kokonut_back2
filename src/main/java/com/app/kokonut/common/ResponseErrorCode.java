...
//    KO008("KO008", "Refresh Token 정보가 일치하지 않습니다."),
    ...
    KO033("KO033", "본인인증된 명의 및 휴대전화번호가 아닙니다. 본인인증을 다시해주세요."),
...
//    KO037("KO037", "입력하신 비밀번호가 서로 일치하지 않습니다."),
    ...
    KO085_1("KO085_1", "만료된 페이지 입니다."),
    KO085_2("KO085_2", "만료된 페이지 입니다."),
    ...
    KO100_1("KO100_1", "구독해지를 실패 했습니다. 코코넛으로 문의해 주시길 바랍니다."),
    KO100_2("KO100_2", "구독해지 취소를 실패 했습니다. 코코넛으로 문의해 주시길 바랍니다."),
    ...
    KO112("KO112", "개인정보제공 정보가 존재하지 않습니다."),
    KO113_1("KO113_1", "개인정보제공 시작전 입니다."),
    KO113_2("KO113_2", "개인정보제공 다운로드 기간이 지났습니다."),
    KO113_3("KO113_3", "제공 종료된 항목입니다."),
    ...
    KO120("KO120", "암호 생성 과정에서 문제가 발생했습니다."),
    ...
    ERROR_CODE_13_1("ERROR_CODE_13_1", "'kokonut_IDX_List'는 'List' 형태로 보내주시길 바랍니다."),
    ERROR_CODE_13_2("ERROR_CODE_13_2", "'codeList'는 'JSON' 또는 'Map' 형태로 보내주시길 바랍니다."),
    ERROR_CODE_14("ERROR_CODE_14", "환경설정 -> 서드파티 -> 비즈엠에서 보낼 대상의 항목을 지정해 주시길 바랍니다."),
    ...
    ERROR_CODE_19("ERROR_CODE_19", "아이디를 입력해주세요."),
    ERROR_CODE_20("ERROR_CODE_20", "비밀번호를 입력해주세요."),
    ERROR_CODE_21("ERROR_CODE_21", "존재하지 않은 아이디 입니다."),
