 ...
 * Date : 2023-06-30
 * Time :
 * Remark : DecrypCountHistoryRepositoryCustom 쿼리문 선언부
 */
@Repository
public class DecrypCountHistoryRepositoryCustomImpl extends QuerydslRepositorySupport implements DecrypCountHistoryRepositoryCustom {

    public final JpaResultMapper jpaResultMapper;

    public DecrypCountHistoryRepositoryCustomImpl(JpaResultMapper jpaResultMapper) {
        super(DecrypCountHistory.class);
        this.jpaResultMapper = jpaResultMapper;
    }

    @Override
    public List<DecrypCountHistoryCountDto> findTodayDecrypCountList(String cpCode) {
        ...
        return jpaResultMapper.list(query, DecrypCountHistoryCountDto.class);
    }
