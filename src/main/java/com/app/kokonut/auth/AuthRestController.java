...
public class AuthRestController {
    ...
    @ApiOperation(value = "이메일 존재여부 확인" , notes = "1. 존재여부를 조회할 이메일을 받는다." +
    ...
    @ApiOperation(value = "이메일 중복확인 버튼" , notes = "1. 이메일 중복확인을 한다." +
    ...
    @ApiOperation(value = "이메일 인증번호 보내기 버튼" , notes = "1. 이메일 중복확인한 이메일의 대해 인증번호를 보낸다." +
    ...
    @ApiOperation(value = "이메일 인증번호 보내기 검증" , notes = "1. 받은 인증번호를 받아 맞는지 확인한다.")
    ...
    @ApiOperation(value = "이메일찾기 기능" , notes = "1. 가입한 휴대전화번호를 인증받는다." +
    ...
    @ApiOperation(value = "비밀번호찾기 기능" , notes = "1. 인증을 완료한 이메일의 대해 임시비밀번호로 업데이트한다." +
            "2. 임시비밀번호를 이메일에 보낸다.")
    ...
    @ApiOperation(value = "비밀번호찾기 기능" , notes = "1. 임시비밀번호를 받는다." +
    ...
    @ApiOperation(value = "이메일 키검증" , notes = "1. 관리자등록을 통해 메일이 온다." +
    ...
    @ApiOperation(value = "관리자등록" , notes = "1. 이메일로 등록신청의 링크를 진입한다." +
            "2. 해당 링크의 키를 통해 검증한다." +
            "3. 휴대폰인증을한다." +
    ...
    @ApiOperation(value = "로그인 - 로그인 성공후 JWT 토큰 발급" , notes = "1. 입력한 아이디와 비밀번호와 OTP값을 보낸다." +
    ...
    @PostMapping("/reissue")
    @ApiOperation(value = "토큰 새로고침" , notes = "1. Param 값으로 accessToken, refreshToken을 받는다." +
    ...
    @ApiOperation(value = "구글 QRCode 보내기 " , notes = "1. 로그인한 이메일 값을 받는다" +
    ...
    @ApiOperation(value = "구글 OTP 등록전 값 확인" , notes = "1. Param 값으로 발급한 otpKey와 입력한 otpValue를 받는다." +
